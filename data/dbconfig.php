...
define('G5_MYSQL_HOST', '31.220.109.104');
define('G5_MYSQL_USER', 'martindb');
define('G5_MYSQL_PASSWORD', 'Damir2014@');
define('G5_MYSQL_DB', 'itc_meb');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'itc_');
...
define('G5_SHOP_TABLE_PREFIX', 'itc_shop_');
